...
> = {
  tr: {
    ...
    tcEntryAlreadyUsed: "Bu TC Kimlik No ile deneme hakkınız dolmuştur.",
    tcEntryExplanation: "Farklı kişiler kullanacağı için TC Kimlik No ile giriş yapılmaktadır. Her kişinin 3 deneme hakkı vardır.",
  ...
  en: {
    ...
    tcEntryAlreadyUsed: "Your attempts for this ID have been exhausted.",
    tcEntryExplanation: "Entry is done with ID number because different people will use it. Each person has 3 attempts.",
